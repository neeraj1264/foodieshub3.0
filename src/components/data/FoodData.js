...
export const PizzaData = [
  ...
  { id: 106,name: "Margharita Pizza[6 inches]", image: '/img/pizza/margherita.png', description: 'Indulge in the timeless elegance of our Margherita Pizza.',price:'100', mrp: '110'},
  { id: 3,  name: "Tomato Onion",               image: '/img/pizza/tomatopizza.png', description: 'Enjoy the timeless combination of tomatoes and onions in a delicious medley that celebrates the essence of traditional pizza.', price: {priceR: '140',priceM: '260',priceL: '370'} , mrp: '190', size: {size1: 'Regular', size2: 'Mediun', size3: 'Large'}},
  { id: 4,  name: "Sweetcorn Tomato",           image: '/img/pizza/tomatopizza.png', description: 'a perfect marriage of sweet corn and ripe tomatoes on a golden crust. ', price: {priceR: '140',priceM: '260',priceL: '370'} , mrp: '190', size: {size1: 'Regular', size2: 'Mediun', size3: 'Large'}},
  { id: 2,  name: "Paneer Onion",               image: '/img/pizza/paneer.jpeg', description: 'Experience a delightful fusion of flavors with our Onion Paneer Pizza. ', price: {priceR: '150',priceM: '280',priceL: '390'} , mrp: '200', size: {size1: 'Regular', size2: 'Mediun', size3: 'Large'}},
  { id: 5,  name: "Paneer Capsicum",          image: '/img/pizza/paneer.jpeg', description: 'is a flavorful and vibrant dish that combines soft and succulent paneer (Indian cottage cheese) with the crunchiness of fresh capsicum ', price: {priceR: '150',priceM: '280',priceL: '390'} , mrp: '200', size: {size1: 'Regular', size2: 'Mediun', size3: 'Large'}},
...
export const DinnerData = [
  ...
  { id: 73, name: 'Kadhai Paneer',   size: {size1: 'Half' , size2: 'Full'}, image: '/img/dinner/kadaipaneer.jpeg', description: 'The dish is cherished for its vibrant colors, bold flavors, and the perfect balance of spiciness and creaminess, making it a favorite in Indian cuisine.', price: {priceH:110, priceF: 170}, mrp: '190'},
  ...
  { id: 76, name: 'Paneer do Pyaza', size: {size1: 'Half' , size2: 'Full'}, image: '/img/dinner/pyaza.jpeg',       description: 'This savory and aromatic dish is beloved for its rich taste and the delicious interplay of paneer and onions in the curry.', price: {priceH:110, priceF: 170}, mrp: '200'},
  ...
  { id: 79, name: 'Malai Kofta',     size: {size1: 'Half' , size2: 'Full'}, image: '/img/dinner/malaikofta.jpeg',  description: 'Garnished with fresh coriander and a drizzle of cream, our Malai Kofta is a symphony of flavors and textures, offering a luxurious experience.', price: {priceH: 110, priceF: 170}, mrp: '180'},
  ...
  { id: 82, name: 'Mushroom Matar',  size: {size1: 'Half' , size2: 'Full'}, image: '/img/dinner/mushroom.jpeg',    description: 'Immerse yourself in the delectable blend of earthy mushrooms and sweet green peas with our Mushroom Matar.', price: {priceH: 100, priceF: 150}, mrp: '180'},
  ...
  { id: 84, name: 'Yellow Dal',      size: {size1: 'Half' , size2: 'Full'}, image: '/img/dinner/yellowdal.jpeg',   description: 'This dish is not only delicious but also a great source of protein and essential nutrients, making it a wholesome and comforting addition to any meal.', price: {priceH: 60, priceF: 90}, mrp: '100' },
  { id: 85, name: 'Rajma',           size: {size1: 'Half' , size2: 'Full'}, image: '/img/dinner/rajma.jpeg',       description: 'Rajma is often garnished with fresh coriander and served with a side of rice, making it a wholesome and satisfying meal.', price: {priceH: 60, priceF: 90}, mrp: '100' },
  { id: 86, name: 'Kadhi',           size: {size1: 'Half' , size2: 'Full'}, image: '/img/dinner/kadhi.jpeg',       description: 'Kadhi is enjoyed for its comforting and tangy taste, making it a popular choice in Indian households.', price: {priceH: 60, priceF: 90}, mrp: '100' },
  { id: 87, name: 'Aloo Matar',      size: {size1: 'Half' , size2: 'Full'}, image: '/img/dinner/aloomatar.jpeg',   description: 'Aloo Matar is often garnished with fresh coriander and served with Indian bread like roti or naan, or alongside steamed rice.', price: {priceH: 60, priceF: 90}, mrp: '100' },
  { id: 88, name: 'Mix Rayta',       size: {size1: 'Half' , size2: 'Full'}, image: '/img/dinner/mixrayta.jpeg',    description: 'Mix Raita not only enhances the overall dining experience by providing a cooling element but also adds nutritional value with the inclusion of vegetables and yogurt.', price: {priceH: 60, priceF: 90}, mrp: '80'  },
  ];
...
//    ];
  ...
  export const NaanData = [
    ...
    { id: 90, size: {size1: 'Half' , size2: 'Full'}, name: 'Butter Naan',  image: '/img/dinner/butternaan.jpeg',  description: 'Butter naan is a delectable Indian flatbread known for its soft and fluffy texture, enriched with the indulgent flavor of butter.', price: 35, mrp: '40' },
    ...
    { id: 99, size: {size1: 'Half' , size2: 'Full'}, name: 'Plain Rice',   image: '/img/dinner/plainrice.jpeg',   description: 'Plain rice is a simple and versatile staple food that is a dietary foundation in many cultures around the world.', price: {priceH: '40', priceF: '70'}, mrp: '60' },
    { id: 107, size: {size1: 'Half' , size2: 'Full'}, name: 'Fried Rice',  image: '/img/dinner/friedrice.jpeg',   description: 'Fried rice can be customized with different vegetables, proteins, and seasonings, making it a flexible and delicious option.', price: 160, mrp: '160' },
  ];
  ...
  export const ShakesData = [
    ...
    { id: 27, name: 'Oreo Shake',                  image: '/img/shakes/oreo.png', description: 'Each sip is a heavenly fusion of chocolatey Oreo goodness and the smoothness of milk, creating a decadent treat for your taste buds.', price: 100, mrp: '120' },
    ...
    { id: 30, name: 'Chocolate Shake',             image: '/img/shakes/choco.jpg', description: 'Dive into the irresistible decadence of our Chocolate Shake. A velvety fusion of rich chocolate syrup and creamy milk.', price: 100, mrp: '120' },
